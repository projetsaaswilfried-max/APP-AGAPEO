...
const TYPE_TO_CATEGORY: Record<NotificationTypeDb, Exclude<NotificationCategory, "ALL" | "UNREAD">> = {
  ...
  CONVERSATION_INVITE: "MESSAGES",
  CONVERSATION_ACCEPTED: "MESSAGES",
  NEW_FAVORITE: "PROFILE",
  PROFILE_VISIT: "PROFILE",
  PROFILE_LIKE: "PROFILE",
  MATCH_REQUEST: "PROFILE",
  MATCH_ACCEPTED: "PROFILE",
...
const TYPE_TO_ICON: Record<NotificationTypeDb, NotificationIconType> = {
  NEW_MESSAGE: "MESSAGE",
  CONVERSATION_INVITE: "MESSAGE",
  CONVERSATION_ACCEPTED: "MESSAGE",
  NEW_FAVORITE: "FAVORITE",
  PROFILE_VISIT: "VIEW",
  PROFILE_LIKE: "LIKE",
  MATCH_REQUEST: "FAVORITE",
  MATCH_ACCEPTED: "FAVORITE",
  POST_LIKE: "LIKE",
